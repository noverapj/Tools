//
// DLL EXPORT 를 위해서 ZEXPORT 를 전부 ZEXTERN으로 바꾸었다. (ZCONF.H 에 정의되어 있음.)
//
...
extern unzFile  unzOpenW OF((const wchar_t *path));
/*
...
extern unzFile  unzOpen2 OF((const char *path, const wchar_t *path2,
